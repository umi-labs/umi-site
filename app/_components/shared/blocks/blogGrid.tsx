...
export default function BlogGrid({ data }: BlogGridProps) {
  const [posts, setPosts] = React.useState<BlogGridProps['data']['blogs']>([]);

  React.useEffect(() => {
    const updatePosts = async () => {
      const updatedPosts = await getRecentPosts();
...
const PostCard = (props: BlogGridProps['data']['blogs'][0]) => {
  ...
  return (
    <div className="grid size-full grid-flow-row auto-rows-auto place-items-center gap-x-10 lg:grid-cols-2 lg:grid-rows-1">
      <Image
      ...
      />
      <div className="flex w-full flex-col items-start justify-around gap-y-8 py-6 pr-6 lg:size-full">
        <div className="flex size-full flex-col items-start justify-center gap-y-3 lg:justify-between">
          <div className="flex w-full items-center justify-between">
            <h6 className="uppercase text-[#368DB1]">
          ...
          <div className="flex w-full items-center justify-between">
            {props.author && (
              <Link href={props.author.slug} className="text-gray-400">
            ...
            {props.time && (
              <div className="flex items-center gap-x-2 text-sm text-gray-400">
                <Icon
                  ...
                  weight={'regular'}
                />
                <span className="text-black">{props.time.timeTaken} mins</span>
              </div>
            )}
          </div>
        </div>
